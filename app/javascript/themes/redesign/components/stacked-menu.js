...
var StackedMenu = (function () {
  ...
  StackedMenu.prototype._handleInteractions = function _handleInteractions (
    items
  ) {
    var self = this
      ...
      self.each.call(el.children, function (child) {
        if (self._hasChild(child)) {
          self.each.call(child.children, function (cc) {
            if (self._hasClass(cc, 'menu-link')) {
              link = cc
            }
          })
  ...
  StackedMenu.prototype._slide = function _slide (
    el,
    direction,
    speed,
    easing
  ...
  StackedMenu.prototype.openMenu = function openMenu (el, emiter) {
    ...
    if (this._hasActive(el) && !this.isCompact()) {
      return
    }
    var self = this
