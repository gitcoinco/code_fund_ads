...
class PropertySearch < ApplicationSearchRecord
  ...
  def initialize(attrs = {})
    ...
    self.programming_languages = (programming_languages || []).reject(&:blank?)
  ...
  def apply(relation)
    ...
    relation
      ...
      .then { |result| result.search_programming_languages(*programming_languages) }
      ...
      .then { |result| result.search_topic_categories(*topic_categories) }
