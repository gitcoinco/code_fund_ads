class UpdateHubspotPublisherDealStageFromAcceptedToIntegratedJob < ApplicationJob
  queue_as :low
  ...
  def perform(user)
    ...
    return unless current_stage && current_stage["label"] == "Accepted"

    next_stage = User.hubspot_publisher_deal_pipeline_stage("Integrated")
