class UpdateHubspotPublisherDealStageFromIntegratedToActivatedJob < ApplicationJob
  queue_as :low
  ...
  def perform(user)
    ...
    return unless current_stage && current_stage["label"] == "Integrated"

    next_stage = User.hubspot_publisher_deal_pipeline_stage("Activated")
