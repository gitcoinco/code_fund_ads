select 1 id, 'Blockchain' "name", 'blockchain_ecpm_cents' ecpm_column_name, '{Blockchain,Cryptography,Solidity}'::text[] keywords
union all
select 2, 'CSS & Design', 'css_and_design_ecpm_cents', '{"CSS & Design"}'
union all
select 3, 'DevOps', 'dev_ops_ecpm_cents', '{DevOps,Security,Serverless}'
union all
...
union all
select 6, 'Miscellaneous', 'miscellaneous_ecpm_cents', '{C,D,"Developer Resources",Erlang,F#,Haskell,IoT,Julia,"Machine Learning",Other,Q,R,Rust,Scala}'
union all
